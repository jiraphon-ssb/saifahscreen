    ...
    <div className="p-8 rounded-lg border bg-card shadow-sm">
      <CardHeader className="p-0 mb-6">
        ...
        <CardDescription className="mt-2">
          ราคานี้รวม: ออกแบบฟรี, สกรีนฟรี 1 จุด (ขนาดใดก็ได้),
          และจัดส่งทั่วประเทศ
        </CardDescription>
      </CardHeader>
      <CardContent className="p-0 space-y-6">
        ...
        <div className="space-y-4">
          <Label className="text-base font-bold">
            ตำแหน่งสกรีนเพิ่มเติม (ฟรี 1 จุดแรก)
          </Label>
            ...
            <div className="flex items-center justify-between rounded-lg border bg-muted/50 p-3">
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm font-medium">
                  ค่าสกรีนเพิ่ม ({totalExtraSpotsCount} จุด)
                </p>
              </div>
              <p className="text-lg font-bold text-primary">
                +{totalExtraSpotsPricePerShirt.toLocaleString()}
                <span className="text-xs font-normal ml-1">บาท/ตัว</span>
              </p>
            </div>
          )}
          {pricePerItem !== null && (
