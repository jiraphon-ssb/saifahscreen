...
import { ImageUp, MessageSquareQuote, Shuffle, Type, Sparkles, Upload, Plus, History, MousePointer2 } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-white font-prompt">
        ...
        <Tabs defaultValue="text" className="w-full">
            <TabsList className="w-full grid grid-cols-2 h-12 bg-zinc-100 rounded-none p-1">
                <TabsTrigger value="text" className="data-[state=active]:bg-white data-[state=active]:text-zinc-950 font-bold text-xs rounded-none transition-all gap-2">
                    <Type className="h-4 w-4" />
                    ข้อความ
                </TabsTrigger>
                <TabsTrigger value="image" className="data-[state=active]:bg-white data-[state=active]:text-zinc-950 font-bold text-xs rounded-none transition-all gap-2">
            ...
            <div className="p-6">
                <TabsContent value="text" className="space-y-6 mt-0">
                    <div className="space-y-4">
                        <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">เพิ่มข้อความพื้นฐาน</h4>
                        <Button 
                            variant="outline" 
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    <p className="text-sm font-bold text-zinc-950 uppercase leading-none">เพิ่มข้อความใหม่</p>
                                    <p className="text-[11px] text-zinc-400 font-medium mt-1">Add basic text string</p>
                                </div>
                            </div>
                    ...
                    <div className="space-y-3">
                        <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">แม่แบบสำเร็จรูป</h4>
                        <div className="grid grid-cols-1 gap-2">
                            {textTemplates.map((template) => (
                                ...
                                >
                                    <div>
                                        <p className="text-[10px] font-bold text-zinc-400 uppercase mb-1">{template.name}</p>
                                        <p className="font-black text-zinc-950 leading-tight" style={{ fontSize: Math.min(template.size / 2.5, 20), fontWeight: template.weight }}>
                                            {template.text}
                                        </p>
                                    </div>
                    ...
                    <div className="space-y-3">
                        <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">อิโมจิยอดนิยม</h4>
                ...
                <TabsContent value="image" className="space-y-6 mt-0">
                    <div className="space-y-3">
                        <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">อัปโหลดรูปภาพ</h4>
                        <div className="border-2 border-dashed border-zinc-200 rounded-3xl p-10 text-center hover:border-zinc-950 hover:bg-zinc-50 transition-all cursor-pointer group">
                            <Label htmlFor="image-upload" className="cursor-pointer flex flex-col items-center gap-4">
                                ...
                                <div>
                                    <p className="font-black text-zinc-950 uppercase tracking-tight">อัปโหลดไฟล์รูปภาพ</p>
                                    <p className="text-[11px] text-zinc-400 font-bold uppercase mt-1">PNG, JPG, SVG (Max 10MB)</p>
                                </div>
                            </Label>
                    ...
                    <div className="p-6 rounded-3xl bg-zinc-950 text-white shadow-xl shadow-zinc-950/10 space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h4 className="text-xs font-black uppercase tracking-tight">คำแนะนำก่อนอัปโหลด</h4>
                        </div>
                        <ul className="text-[11px] font-bold text-white/60 space-y-2 uppercase leading-relaxed">
                            <li className="flex items-start gap-2"><div className="h-1.5 w-1.5 rounded-full bg-white mt-1 shrink-0" /> ใช้รูปความละเอียดสูงเพื่อความคม</li>
                            <li className="flex items-start gap-2"><div className="h-1.5 w-1.5 rounded-full bg-white mt-1 shrink-0" /> ไฟล์ PNG พื้นหลังโปร่งใสดีที่สุด</li>
                            <li className="flex items-start gap-2"><div className="h-1.5 w-1.5 rounded-full bg-white mt-1 shrink-0" /> หลีกเลี่ยงข้อความที่เล็กเกินไป</li>
                        </ul>
                    </div>
                </TabsContent>
            </div>
