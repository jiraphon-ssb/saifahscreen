...
export default function CanvasArea({
  ...
  useEffect(() => {
    ...
    const calculateSize = () => {
      ...
      const baseSize = Math.min(
        ...
        availableHeight > 0 ? availableHeight : 500,
      );
  ...
  return (
    <TooltipProvider delayDuration={200}>
      <main
        ref={containerRef}
        className="relative flex-1 h-full min-h-0 overflow-hidden bg-zinc-50/50"
      >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-9 w-9 rounded-xl text-zinc-500 hover:text-red-600 hover:bg-red-50"
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-9 w-9 rounded-xl text-zinc-500 hover:text-zinc-950 hover:bg-zinc-100"
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        className="h-9 w-9 rounded-xl text-zinc-500 hover:text-zinc-950 hover:bg-zinc-100"
                        onClick={() => {
                          const flip = selectedElement.flip || {
                            horizontal: false,
                            vertical: false,
                          };
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="outline"
                size="icon"
                className="h-9 w-9 rounded-xl bg-white/90 backdrop-blur-sm border-zinc-200 shadow-md hover:bg-white"
