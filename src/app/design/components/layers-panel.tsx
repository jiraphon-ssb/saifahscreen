...
import { Eye, Layers, Type, Image as ImageIcon, EyeOff, Copy, Trash2 } from 'lucide-react';
      ...
      <div className="flex flex-col h-full bg-white font-prompt">
        ...
        {elements.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center p-10 space-y-4">
            ...
            <div>
                <p className="text-xs font-bold text-zinc-400 uppercase tracking-wider">ยังไม่มีเลเยอร์</p>
                <p className="text-[10px] text-zinc-300 mt-1 font-medium">เพิ่มข้อความหรือรูปภาพเพื่อเริ่ม</p>
            </div>
          </div>
        ) : (
                ...
                >
                  <CardContent className="p-2.5 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-[11px] font-bold truncate tracking-tight">{element.name}</p>
                        <p className={cn(
                            "text-[9px] font-medium uppercase opacity-60",
                            selectedElementId === element.id ? "text-white/70" : "text-zinc-400"
                        )}>
                    ...
                    <div className={cn(
                        ...
                        selectedElementId === element.id ? "opacity-100" : "opacity-0 group-hover:opacity-100"
                    )}>
                      <Tooltip>
                          <TooltipTrigger asChild>
                            <Button 
                                ...
                                className={cn(
                                    "h-7 w-7 rounded-lg",
                                    selectedElementId === element.id ? "hover:bg-white/10 text-white" : "hover:bg-zinc-100 text-zinc-400"
                                )} 
                          ...
                          <TooltipContent side="top" className="bg-zinc-950 text-white border-none font-bold text-[10px]">ซ่อน/แสดง</TooltipContent>
                      </Tooltip>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="top" className="bg-zinc-950 text-white border-none font-bold text-[10px]">ทำซ้ำ</TooltipContent>
                      </Tooltip>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                           <Button 
                                ...
                                className={cn(
                                    "h-7 w-7 rounded-lg",
                                    selectedElementId === element.id ? "hover:bg-red-500/20 text-red-300" : "hover:bg-red-50 text-zinc-400 hover:text-red-500"
                                )} 
                        ...
                        <TooltipContent side="top" className="bg-red-600 text-white border-none font-bold text-[10px]">ลบ</TooltipContent>
                      </Tooltip>
                    </div>
