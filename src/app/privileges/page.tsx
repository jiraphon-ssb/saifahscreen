import { BadgeCheck, Box, DollarSign, Gift, Layers3, Pencil, ReceiptText, ShieldCheck, Truck, ArrowRight } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 py-16 md:py-24 space-y-24 relative z-10">
                ...
                <section>
                    <AnimateOnScroll delay={100} className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-6xl font-semibold font-headline tracking-tight drop-shadow-sm mb-4">
                            สิทธิพิเศษ & <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-amber-500">ของแถม</span>
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                        {privileges.map((item, index) => {
                            ...
                            return (
                                <AnimateOnScroll key={index} delay={200 + index * 100} className="group relative rounded-[24px] border border-border/60 bg-card/40 backdrop-blur-md p-8 text-center transition-all duration-500 hover:-translate-y-2 hover:border-primary/50 hover:shadow-2xl hover:bg-card/80">
                                    <div className={"absolute top-4 right-4 px-3 py-1 text-xs font-semibold tracking-wider rounded-full border shadow-sm " + tagColor}>
                                        {item.tag}
                                    </div>
                ...
                <section>
                    <AnimateOnScroll delay={100} className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-6xl font-semibold font-headline tracking-tight drop-shadow-sm mb-4">
                            การันตี<span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-sky-400">ความพึงพอใจ</span>
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        {guarantees.map((item, index) => (
                            <AnimateOnScroll key={index} delay={200 + index * 150} className="relative overflow-hidden rounded-[32px] border border-border/60 bg-card/60 backdrop-blur-md p-10 text-center transition-all duration-500 hover:border-primary/50 hover:shadow-2xl hover:-translate-y-2">
                                <div className="flex justify-center mb-6">
