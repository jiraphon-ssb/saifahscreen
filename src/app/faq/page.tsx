...
export default function FaqPage() {
  const generalFaqs = [
    ...
    },
    {
      ...
      a: "ระยะเวลาการผลิตโดยทั่วไปอยู่ที่ 14-21 วันทำการหลังจากการยืนยันแบบและตัวอย่าง ส่วนการจัดส่งขึ้นอยู่กับพื้นที่และวิธีการจัดส่งที่คุณเลือก",
    },
    {
    ...
    },
    {
      ...
      a: "ใช่ เรามีเครื่องมือออกแบบที่ทันสมัย และ AI ช่วยออกแบบที่ช่วยให้คุณสร้างสรรค์ผลงานได้อย่างง่ายดาย นอกจากนี้ยังมีทีมงานคอยให้คำปรึกษา",
    },
  ];
  ...
  const fullFaqsLeft = [
    {
      ...
      a: "เรามีผ้าให้เลือกหลากหลายชนิด ตั้งแต่ Cotton, CVC, TC, ไปจนถึงผ้า Dry Tech ที่มีคุณสมบัติพิเศษต่างๆ เพื่อให้เหมาะสมกับการใช้งานและงบประมาณของคุณ",
    },
    {
      q: "SAIFAH มีนโยบายการคืนสินค้าอย่างไร?",
      a: "เรารับประกันคุณภาพสินค้า หากสินค้ามีปัญหาจากการผลิต เรายินดีแก้ไขหรือผลิตให้ใหม่ตามเงื่อนไขที่ตกลงกัน กรุณาตรวจสอบสินค้าและแจ้งปัญหาภายใน 7 วันหลังได้รับสินค้า",
    },
    {
      q: "การชำระเงินสำหรับการสั่งผลิตเสื้อทำอย่างไร?",
      a: "เรารับชำระเงินผ่านการโอนเงินผ่านธนาคาร โดยแบ่งเป็นค่ามัดจำ 50% ก่อนเริ่มผลิต และชำระส่วนที่เหลือ 50% ก่อนการจัดส่ง",
    },
    {
    ...
    },
    {
      ...
      a: "เรามีการควบคุมคุณภาพในทุกขั้นตอนการผลิต ตั้งแต่การเลือกผ้า, การตัดเย็บ, ไปจนถึงงานพิมพ์ เพื่อให้คุณมั่นใจว่าจะได้รับสินค้าที่มีคุณภาพมาตรฐาน",
    },
    {
      q: "สามารถขอเปลี่ยนหรือยกเลิกคำสั่งซื้อได้หรือไม่?",
      a: "หากยังไม่มีการขึ้นตัวอย่างหรือเริ่มการผลิต คุณสามารถเปลี่ยนแปลงรายละเอียดได้ แต่หากเริ่มกระบวนการผลิตแล้วจะไม่สามารถยกเลิกหรือเปลี่ยนแปลงได้",
    },
    {
      q: "สามารถติดตามสถานะการผลิตและการจัดส่งได้อย่างไร?",
      a: "คุณสามารถติดต่อฝ่ายขายที่ดูแลโปรเจกต์ของคุณเพื่อสอบถามและติดตามสถานะการผลิตได้ตลอดเวลา",
    },
    {
    ...
    {
      q: "SAIFAH มีบริการจัดส่งระหว่างประเทศหรือไม่?",
      a: "ในปัจจุบันเรายังไม่มีบริการจัดส่งระหว่างประเทศโดยตรง แต่สามารถจัดส่งไปยังบริษัทขนส่ง (Freight Forwarder) ที่คุณเลือกในประเทศไทยได้",
    },
  ];
  ...
  const fullFaqsRight = [
    {
      ...
      a: "ขออภัยครับ ปัจจุบันเรายังไม่มีบริการเก็บเงินปลายทาง",
    },
    {
      q: "มีการให้คำปรึกษาด้านการออกแบบและการเลือกผ้าหรือไม่?",
      a: "ใช่ เรามีทีมงานที่พร้อมให้คำปรึกษาทั้งด้านการออกแบบ, การเลือกใช้ผ้า, และเทคนิคการพิมพ์ เพื่อให้งานของคุณออกมาดีที่สุด",
    },
    {
      q: "สามารถเยี่ยมชมโรงงานหรือชมสินค้าจริงได้ที่ไหน?",
      a: "คุณสามารถนัดหมายเพื่อเข้ามาชมตัวอย่างผ้าและสินค้าจริงได้ที่โชว์รูมของเรา กรุณาติดต่อเพื่อนัดหมายล่วงหน้า",
    },
    {
      q: "สามารถออกใบเสร็จและใบกำกับภาษีได้หรือไม่?",
      a: "ได้ บริษัทของเราจดทะเบียนถูกต้อง สามารถออกใบกำกับภาษีเต็มรูปแบบได้",
    },
    {
      q: "วิธีการขอใบกำกับภาษีจาก SAIFAH ต้องทำอย่างไร?",
      a: "คุณสามารถแจ้งขอใบกำกับภาษีได้ในขั้นตอนการสั่งซื้อ โดยส่งข้อมูลชื่อ-ที่อยู่และเลขประจำตัวผู้เสียภาษีให้กับฝ่ายขาย",
    },
    {
      q: "SAIFAH ออกใบกำกับภาษีแบบเต็มรูปแบบหรือไม่?",
      a: "ใช่ เราออกใบกำกับภาษีเต็มรูปแบบตามมาตรฐานของกรมสรรพากร",
    },
    {
      q: "หากลูกค้าต้องการใบเสร็จรับเงินหรือใบกำกับภาษีซ้ำ ควรทำอย่างไร?",
      a: "กรุณาติดต่อฝ่ายขายหรือฝ่ายบัญชีของเราเพื่อขอสำเนาเอกสารได้",
    },
    {
    ...
    },
    {
      ...
      a: "กรุณาแจ้งฝ่ายขายหรือฝ่ายบัญชีทันทีที่พบข้อผิดพลาดเพื่อดำเนินการแก้ไขให้ถูกต้อง",
    },
  ];
    ...
    <Accordion type={type} collapsible className="w-full space-y-4">
      {faqs.map((faq, index) => (
        <AnimateOnScroll key={index} delay={delayStart + index * 100}>
          <AccordionItem
            value={`item-${index}`}
            className="bg-card/50 backdrop-blur-sm border border-border/60 rounded-[20px] px-2 py-1 transition-all hover:border-primary/50 hover:shadow-lg"
          >
    ...
    <div className="bg-gradient-to-b from-background via-secondary/10 to-background w-full min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 space-y-24 relative z-10">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <AnimateOnScroll
            delay={100}
            className="lg:col-span-1 lg:sticky top-24"
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6 font-headline tracking-tight">
              คำถามที่พบบ่อย
            </h2>
            <p className="text-muted-foreground text-lg">
              คำถามทั่วไปที่ลูกค้ามักสอบถามเข้ามาเกี่ยวกับบริการของเรา
            </p>
          </AnimateOnScroll>
        ...
        <section>
          <AnimateOnScroll delay={100} className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-2">
              ค้นหาคำตอบสำหรับทุกคำถามของคุณที่นี่
            </p>
          </AnimateOnScroll>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-4 max-w-6xl mx-auto">
            <div>{renderFaqAccordion(fullFaqsLeft, "single", 200)}</div>
            <div>{renderFaqAccordion(fullFaqsRight, "single", 200)}</div>
          </div>
        </section>
        ...
        <section className="text-center py-12">
          <AnimateOnScroll delay={100}>
            ...
            <p className="text-muted-foreground text-lg mb-8">
              ทีมงานพร้อมให้คำปรึกษาและช่วยเหลือคุณเสมอ
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <Button
                  size="lg"
                  className="rounded-full px-8 h-14 text-base font-semibold shadow-lg hover:shadow-xl transition-all hover:scale-105 group"
                >
