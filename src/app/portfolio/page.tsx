...
export const metadata: Metadata = {
  ...
  description: 'รวมผลงานสกรีนเสื้อด่วน สกรีนเสื้อ DTF คุณภาพพรีเมียมจากลูกค้าที่ไว้วางใจ SAIFAH Studio ชมตัวอย่างงานสกรีนเสื้อบริษัท หน่วยงาน และงานกิจกรรม',
  openGraph: {
