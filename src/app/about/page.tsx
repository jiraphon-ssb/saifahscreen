  ...
  const differences = [
    {
      ...
      title: "AI ช่วยออกแบบ",
      description:
        "ให้ AI ช่วยคุณสร้างสรรค์ดีไซน์ที่ไม่เหมือนใครจากไอเดียของคุณ",
    },
    {
      icon: <Shirt className="h-8 w-8" />,
      title: "วัตถุดิบพรีเมียม",
      description:
        "เราเลือกใช้เฉพาะผ้าคอตตอนเกรดพรีเมียม เพื่อความสบายและทนทาน",
    },
    {
    ...
    },
    {
      ...
      title: "จัดส่งรวดเร็ว",
      description:
        "ระบบการผลิตและจัดส่งที่รวดเร็ว เชื่อถือได้ ส่งตรงถึงหน้าบ้านคุณ",
    },
    {
      icon: <Infinity className="h-8 w-8" />,
      title: "ไม่มีขั้นต่ำ",
      description:
        "สั่งทำเสื้อได้แม้เพียงตัวเดียว หรือจะสั่งเป็นทีม เราก็พร้อมให้บริการ",
    },
    {
  ...
  const commitments = [
    {
      ...
      description:
        "ตั้งแต่เส้นใยผ้า Cotton จาก USA ไปจนถึงหมึกพิมพ์ที่เราคัดสรร ทุกองค์ประกอบต้องดีที่สุด",
    },
    {
      icon: <Laptop className="h-10 w-10" />,
      title: "เครื่องมือที่ทันสมัย",
      description:
        "เรามีเครื่องมือออกแบบออนไลน์ที่ใช้งานง่าย ช่วยให้คุณสร้างสรรค์ผลงานได้อย่างแม่นยำและสะดวกสบาย",
    },
    {
      icon: <Truck className="h-10 w-10" />,
      title: "บริการที่เชื่อถือได้",
      description:
        "ประสบการณ์ที่ราบรื่นตั้งแต่การออกแบบ, การสั่งซื้อ, จนถึงการจัดส่งที่รวดเร็วและตรงเวลา",
    },
  ];
      ...
      <section className="relative w-full h-[60vh] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-20 container px-4 md:px-6 space-y-8 mt-12">
          ...
          <AnimateOnScroll
            as="h1"
            delay={200}
            className="text-4xl font-bold tracking-tight font-headline sm:text-5xl md:text-7xl drop-shadow-2xl"
          >
            WE ARE SAIFAH
          </AnimateOnScroll>
          <AnimateOnScroll
          ...
          >
            สตูดิโอที่ผสานเทคโนโลยีการพิมพ์และพลังของ AI เข้าด้วยกัน
            เพื่อสร้างสรรค์เสื้อผ้าที่ไม่ใช่แค่เครื่องแต่งกาย แต่คือการแสดงตัวตน
          </AnimateOnScroll>
          <AnimateOnScroll delay={400}>
            <Button asChild size="lg">
              <Link href="/design">ปลดปล่อยความคิดสร้างสรรค์</Link>
            </Button>
          </AnimateOnScroll>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <p className="max-w-[900px] text-muted-foreground md:text-xl font-medium">
              SAIFAH ไม่ใช่แค่ชื่อ
              แต่คือมาตรฐานที่เรายึดมั่นเพื่อมอบสิ่งที่ดีที่สุดให้แก่คุณ
            </p>
          </AnimateOnScroll>
          <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-3">
            {commitments.map((item, index) => (
              <AnimateOnScroll
                key={item.title}
                delay={200 + index * 150}
                className="grid gap-2 text-center group"
              >
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center">
            {[
              ...
              >
                <span className="text-3xl md:text-5xl font-bold text-white drop-shadow-lg mb-2">
                  {stat.number}
                </span>
            ...
            {differences.map((item, index) => (
              <AnimateOnScroll key={item.title} delay={200 + index * 100}>
                <Card className="bg-card/40 backdrop-blur-sm border-border/50 hover:border-primary/50 hover:bg-card/80 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 rounded-[24px]">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground text-base tracking-wide leading-relaxed">
                      {item.description}
                    </p>
                  </CardContent>
                </Card>
